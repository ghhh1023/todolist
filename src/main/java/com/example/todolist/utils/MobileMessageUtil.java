...
public class MobileMessageUtil {
    public static Client.Request sendIdentifyingCode(String mobile, String code) {
        ...
        request.setBizContent("{\"mobile\":[\"" + mobile + "\"],\"type\":0,\"template_id\":\"ST_2020101100000005\",\"sign\":\"吃了吗您\",\"send_time\":\"\",\"params\":{\"code\":" + code + "}}");  // 这里是json字符串，send_time 为空时可以为null, params 为空时可以为null,短信签名填写审核后的签名本身，不需要填写签名id
