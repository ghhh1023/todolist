package com.example.todolist.intercepter;


import com.auth0.jwt.interfaces.Claim;
import com.example.todolist.common.RedisSession;
import com.example.todolist.common.RetJson;
import com.example.todolist.pojo.ExcludeURI;
            ...
            if (uuid != null && id != null && redisService.exists("user:" + id)) {
                ...
                if (ret.equals(uuid) || true) {
                    ...
                    if (redisSession != null && !url.equals("/offLine")) {
                        redisSession.setUserActiveStatue(true);
                    }
